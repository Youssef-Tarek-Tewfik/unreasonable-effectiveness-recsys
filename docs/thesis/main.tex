...
\begin{titlepage}
    ...
    \noindent
    I hereby declare that I wrote this thesis independently and used only the sources and aids cited in the thesis, together with the following additional tools: standard text-processing and programming tools, university computing infrastructure for running experiments, and AI-based language assistance for drafting and stylistic revision.

    \vspace{0.8cm}

    \noindent
    I reviewed and verified all content, arguments, analyses, and final formulations myself. All direct and indirect quotations, translations, and ideas taken from other works or electronic sources, including material from the World Wide Web, generative AI systems, and other digital data collections, have been identified as such in each individual case.

    \vspace{0.8cm}

    \noindent
    I acknowledge that any proven omission of source attribution may be regarded as attempted deception. I further confirm that the content of the electronic version is the same as the printed version.
