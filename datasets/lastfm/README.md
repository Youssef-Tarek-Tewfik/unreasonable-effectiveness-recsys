...
------------------------------------------------------------------------------------
------------------------------------------------------------------------------------
The file lfm1b-tracks.inter comprising the tracks that users have listened.
Each record/line in the file has the following fields: user_id, tracks_id, timestamp, num_repeat
...
num_repeat: the number of times that the user has listened this album, and its type is float.

TRACK INFORMATION DATASET FILE DESCRIPTION
------------------------------------------------------------------------------------
------------------------------------------------------------------------------------
The file lfm1b-tracks.item comprising the attributes of the tracks.
Each record/line in the file has the following fields: tracks_id, name, artists_id
